...
Initial release of agcm, a terminal user interface for browsing Red Hat support cases.
...
- **Secure Token Storage**: Tokens stored in system keyring (macOS Keychain, Windows Credential Manager, Linux Secret Service)
- **Self-Update**: Update to latest version directly with `agcm update`
